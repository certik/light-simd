...
namespace lsimd { namespace sse {
	...
	struct smat_core<f32, 2, 2>
	{
		...
		LSIMD_ENSURE_INLINE
		smat_core(sse_f32pk c01) : col01_pk( c01 ) { }
	...
	struct smat_core<f32, 2, 3>
	{
		...
		LSIMD_ENSURE_INLINE
		smat_core(sse_f32pk c01, sse_f32pk c2)
	...
	struct smat_core<f32, 3, 3>
	{
		...
		LSIMD_ENSURE_INLINE
		smat_core(vec_t v0, vec_t v1, vec_t v2 )
	...
	struct smat_core<f32, 3, 4>
	{
		...
		LSIMD_ENSURE_INLINE
		smat_core(vec_t v0, vec_t v1, vec_t v2, vec_t v3 )
